...
@NamedQuery(name="valorMaximoDaConta",query="select max(m.valor) from Movimentacao m where m.conta=:pConta")
})
...
public class Movimentacao {
    ...
    @Id @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "SEQ_MOVIMENTACAO")
    private Integer id;
